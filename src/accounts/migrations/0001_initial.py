...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('diploma_number', models.CharField(help_text='Official diploma number.', max_length=50, verbose_name='Diploma number')),
                ('diploma_issue_date', models.DateField(help_text='Date when the diploma was issued.', validators=[accounts.validators.validate_diploma_issue_date], verbose_name='Diploma issue date')),
                ('specialization', models.CharField(blank=True, help_text='Medical specialization, e.g. Cardiology (optional).', max_length=100, verbose_name='Specialization')),
                ('user', models.OneToOneField(help_text='The doctor this data belongs to.', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Doctor')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Optional profile image.', null=True, upload_to='profile_pics/', verbose_name='Profile picture')),
